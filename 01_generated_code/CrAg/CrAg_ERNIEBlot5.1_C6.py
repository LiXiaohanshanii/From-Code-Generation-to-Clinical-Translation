...
# 5.2 独热编码变量
# handle_unknown='ignore' 防止测试集中出现未见类别时报错
...
print(f"   Pipeline预处理后特征数: {best_model.named_steps['preprocessor'].transform(X_train).shape[1]}")